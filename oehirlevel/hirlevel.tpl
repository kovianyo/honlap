                      ...
                      <tr>
                        ...
                        <tr>
                          <td style="padding-bottom: 10px; padding-right: 0px; padding-top: -10px; padding-left: 30px;">
                            ...
                            <div style="text-align:left; color: #ffffff; font-family: Helvetica, arial, sans-serif; font-size: 1.0em; ">{$hirlevelTitle}</div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <table width="425" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                          <tbody>
                            <!-- Spacing -->
                            <tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #333333; text-align:left; line-height: 20px; padding: 0 10px 0 10px">
                                ...
                                {foreach $kategoria.hirek as $hir}
                                <a name="hir_{$hir.hir_id}"></a>
                                <h2>{$hir.hir_cim} {$hir.hir_imageTag} </h2>{$hir.hir_szoveg}<br> <br>
                                <a href="#top"><img src="http://oehirlevel.cserkesz.hu/images/fel.jpg" height="25" align="right"></a>
                                {if !$hir@last}<br><br><hr style="color: #A0A0A0; border-style:solid; border-width: 1px;">{else}{/if}
                                {/foreach}
